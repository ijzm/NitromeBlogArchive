...
M("about:blank");function na(a,b){a.src=b instanceof I&&b.constructor===I&&b.c===J?b.a:"type_error:TrustedResourceUrl";if(null===k){a:{var c=g.document;if((c=c.querySelector&&c.querySelector("script[nonce]"))&&(c=c.nonce||c.getAttribute("nonce"))&&aa.test(c))break a;c=null}k=c||""}(c=k)&&a.setAttribute("nonce",c)}
